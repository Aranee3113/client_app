<template>
  ...
  <div class="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
    ...
    <!-- Footer Bottom --> <p class="text-sm text-center text-gray-500 dark:text-gray-400"> © 2025 <span class="font-semibold text-amber-900 dark:text-orange-400"> สานเขมร </span> </p>
  </div>
</footer>
